    ...
    return (
        <div style={{ minHeight: '100vh', background: 'var(--bg-primary)', color: 'var(--text-primary)' }}>
            ...
            <div style={{
                ...
                <img src="/umae-icon.png?v=3" alt="UMAE" width={48} height={48} style={{ borderRadius: 14, marginBottom: 12 }} />
            ...
            <div style={{ maxWidth: 700, margin: '0 auto', padding: '24px 16px' }}>
                ...
                <div style={{ textAlign: 'center', padding: '24px 0 48px', borderTop: '1px solid var(--border)', marginTop: 24 }}>
                    <img src="/umae-icon.png?v=3" alt="UMAE" width={32} height={32} style={{ borderRadius: 10, marginBottom: 8 }} />
