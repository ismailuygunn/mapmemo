...
export const ISTANBUL_SPOTS = [
    ...
    // ═══ EKSTRA NİŞ&KEŞFET ═══
    p('Balıklı Rum Kilisesi', 'photospot', 41.0060, 28.9320, 'Ayazma ve yeraltı havuzu. Bizantiondan kalma giz.', ['gizli', 'tarihi', 'bizans'], 5),
    p('Ağa Camii Beyoğlu', 'view', 41.0345, 28.9785, 'Mini cami büyük şehirde. Kontrast fotoğrafçılık.', ['gizli', 'cami', 'sokak'], 3),
    p('Kadıköy Antikacılar Çarşısı', 'photospot', 41.0135, 29.0220, 'Vintage objeler, eski plaklar. Makro ve stil.', ['sokak', 'sanat', 'gizli'], 4),
    ...
    p('Tophane-i Amire', 'photospot', 41.0260, 28.9810, 'Osmanlı top dökümhanesi. Sanat galerisi oldu.', ['sanat', 'tarihi', 'modern'], 4),
    p('Vefa Bozacısı', 'food', 41.0140, 28.9660, '1876\'dan beri boza. Nostaljik mekan. Portre ideal.', ['yemek', 'tarihi', 'gizli'], 4),
    p('Yeniköy Sahili', 'photospot', 41.1200, 29.0580, 'Boğaz köyü havası. Ahşap evler + balıkçılar.', ['deniz', 'sokak', 'gizli'], 4),
    p('Sakız Adası Sokağı - Büyükada', 'photospot', 41.0840, 29.1190, 'Renkli ahşap evler. Begonvil sarmaşıklar.', ['sokak', 'renkli', 'gizli'], 5),
    p('Çemberlitaş Hamamı', 'photospot', 41.0080, 28.9710, '1584 yapımı. Osmanl kubbe mimarisi iç mekan.', ['tarihi', 'mimari', 'atmospheric'], 4),
    p('Asmalımescit Sokakları', 'photospot', 41.0310, 28.9760, 'Meyhane kültürü. Akşam ışıkları, vintage.', ['sokak', 'gece', 'yemek'], 4),
    p('Balat Bulvar Çay Bahçesi', 'view', 41.0285, 28.9505, 'Haliç manzaralı çay bahçesi. Yerel atmosfer.', ['gizli', 'panorama', 'sokak'], 4),
    p('İstanbul Havalimanı Mimarisi', 'photospot', 41.2750, 28.7510, 'Dünyanın en büyük havalimanı. Lale motifli tavan.', ['mimari', 'modern', 'ikon'], 4),
    p('Unkapanı Köprüsü Altı', 'photospot', 41.0190, 28.9600, 'Grafiti + urban doku. Gölge-ışık kontrast.', ['sokak', 'sanat', 'urban'], 4),
    p('Şile Feneri', 'photospot', 41.1800, 29.6100, 'Karadeniz feneri. Dramatik dalgalar. Yalnızlık.', ['deniz', 'doga', 'gizli'], 5),
    p('Ağva Nehir Ağzı', 'view', 41.1300, 29.8200, 'İki nehir birleşimi. Yeşil + mavi doğa cenneti.', ['doga', 'deniz', 'gizli'], 4),
    p('Kadıköy Moda İskelesi', 'photospot', 41.0168, 29.0240, 'Tarihi ahşap iskele. Gün batımı + Adalar.', ['deniz', 'sokak', 'panorama'], 5),
    p('Kandilli Sahil', 'view', 41.0700, 29.0600, 'Boğazın sakin köşesi. Yalılar + deniz.', ['deniz', 'gizli', 'sokak'], 4),
    p('Beyazıt Devlet Kütüphanesi', 'photospot', 41.0110, 28.9660, 'Neo-klasik mimari. Sessiz iç mekan çekimleri.', ['mimari', 'tarihi', 'gizli'], 4),
    ...
    p('Çukurcuma Antikacılar', 'photospot', 41.0330, 28.9810, 'Antika dükkanlar. Orhan Pamuk Masumiyet Müzesi.', ['sokak', 'sanat', 'gizli'], 5),
    ...
    p('Tünel Geçidi', 'photospot', 41.0260, 28.9740, 'Dünyanın 2. en eski metrosu. Nostaljik vagon.', ['tarihi', 'gizli', 'sokak'], 4),
    p('Üsküdar Mihrimah Sultan Camii', 'photospot', 41.0260, 29.0150, 'Mimar Sinan eseri. Boğaz manzarası eşliğinde.', ['tarihi', 'cami', 'panorama'], 5),
    p('Kumkapı Balıkçılar', 'food', 41.0020, 28.9650, 'Balık restoranları sokağı. Canlı müzik + atmosfer.', ['yemek', 'sokak', 'gece'], 4),
    ...
    p('Adalar Vapuru İçi', 'photospot', 41.0250, 29.0350, 'Vapur iç mekan. Ahşap + nostaljik detaylar.', ['deniz', 'sokak', 'atmospheric'], 4),
    ...
    p('Üsküdar Valide-i Cedid Camii', 'photospot', 41.0260, 29.0170, 'İskele kenarı cami. Gün batımı siluet çekimi.', ['tarihi', 'cami', 'deniz'], 4),
